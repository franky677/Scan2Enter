...
/**
 * Store in memoria della lista di riordino.
 *
 * In questa prima versione:
 * - evita i duplicati tramite articleId;
 * - conserva i dati necessari per il riordino;
 * - permette il raggruppamento per fornitore;
 * - non calcola ancora automaticamente la quantità da ordinare.
 */
object ReorderStore {
    ...
    /**
     * Aggiunge un articolo solo se non è già presente.
     *
     * @return true se l'articolo è stato aggiunto, false se era già presente.
     */
    @Synchronized
    ...
    /**
     * Raggruppa gli articoli per supplierId.
     *
     * Il supplierId 0 rappresenta articoli senza fornitore predefinito.
     */
    @Synchronized
    ...
    private fun logAdded(item: ReorderItem) {
        ...
        Log.d(
            TAG,
            "CODICE FORNITORE = ${item.supplierArticleCode}"
        )
    ...
    /**
     * Converte quantità salvate come String in Double.
     *
     * Supporta sia il punto sia la virgola decimale.
     * Una stringa vuota o non numerica restituisce null.
     */
